;(function ($) {
  ...
  $(document).on('click', '.sow-accordion-panel', function () {
    ...
    var slider_wrap = $('#accordion-content-' + ele_control).find(
      '.wpsisac-slick-init'
    )
  ...
  jQuery('.wpsisac-slick-slider').each(function (index) {
    ...
    if (Wpsisac.is_avada == 1) {
      jQuery(this)
        ...
        .addClass('wpsisac-fusion-flex')
    }

    var slider_id = jQuery(this).attr('id')
    var slider_conf = jQuery.parseJSON(
      jQuery(this).closest('.wpsisac-slick-slider-wrp').attr('data-conf')
    )
...
function wpsisac_slick_carousel_init() {
  ...
  jQuery('.wpsisac-slick-carousal').each(function (index) {
    ...
    var slider_id = jQuery(this).attr('id')
    var slider_conf = jQuery.parseJSON(
      jQuery(this).closest('.wpsisac-slick-carousal-wrp').attr('data-conf')
    )
      ...
      responsive: [
        {
          ...
          settings: {
            slidesToShow:
              parseInt(slider_conf.slidestoshow) > 3
                ? 3
                : parseInt(slider_conf.slidestoshow),
            slidesToScroll: 1
          }
        },
        {
