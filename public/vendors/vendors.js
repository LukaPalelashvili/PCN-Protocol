...
!(function () {
  ...
  function w() {
    if (!c && document.body) {
      ...
      var n = document.body,
        ...
        s = n.scrollHeight
      if (
        ((u = document.compatMode.indexOf('CSS') >= 0 ? l : n),
        (e = n),
        r.keyboardSupport && X('keydown', g),
        top != self)
      )
        i = !0
          ...
          (o = function () {
            f ||
              (f = setTimeout(function () {
                a ||
                  ((m.style.height = '0'),
                  (m.style.height = u.scrollHeight + 'px'),
                  (f = null))
              }, 500))
          }),
          setTimeout(o, 10),
      ...
      var u = e === document.body,
        d = function (n) {
          ...
          u
            ...
            t || o || (h = []),
            h.length ? P(d, e, 1e3 / r.frameRate + 1) : (p = !1)
        }
      P(d, e, 0), (p = !0)
    }
  }
  ...
  function b(t) {
    ...
    return l
      ? !!(function (e) {
          ...
          (Math.abs(n) > 1.2 && (n *= r.stepSize / 120),
          Math.abs(a) > 1.2 && (a *= r.stepSize / 120),
          y(l, n, a),
          t.preventDefault(),
          void E())
      : !i ||
  ...
  function g(t) {
    ...
    if (
      ...
      return !0
    if (
      (A(o, 'button') || (A(o, 'input') && a.test(o.type))) &&
  ...
  'onwheel' in document.createElement('div')
    ? (F = 'wheel')
    : 'onmousewheel' in document.createElement('div') && (F = 'mousewheel'),
        ...
        for (var n in this._headers)
          if (
            ...
            this._headers[n].element.css(h),
              ...
              this._headers[n].element.find('> .' + this.options.innerClass)
                .length ||
                this._headers[n].element.wrapInner(
                  '<div class="' + this.options.innerClass + '"></div>'
                ),
              (this._headers[n].inner = this._headers[n].element.find(
      ...
      _recalculateHeaders: function () {
        ...
        for (var a in this._headers)
          this._headers.hasOwnProperty(a) &&
            ((this._headers[a].from = ''), (this._headers[a].progress = 0))
        for (var h = 0; h < this._sections.length; h++)
          s >= this._sections[h].start &&
            ...
            e >= this._sections[h].start && s <= this._sections[h].end
              ? ((this._headers[this._sections[h].className].from = 'top'),
                (this._headers[this._sections[h].className].progress += 1))
              : s > this._sections[h].end && e < this._sections[h].end
              ? ((this._headers[this._sections[h].className].from = 'top'),
                (this._headers[this._sections[h].className].progress =
                  1 - (s - this._sections[h].end) / t))
              : s > this._sections[h].start &&
